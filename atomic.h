...
/**
 * atomically increase the integer value (8 bits, 16 bits, 32 bits or 64 bits) by 1
 * @pv: the integer to be increased
...
/**
 * atomically decrease the integer value (8 bits, 16 bits, 32 bits or 64 bits) by 1
 * @pv: the integer to decreased
...
/**
 * Compare and exchange. Compare *pv to cv, if equal, set nv into *pv, otherwise do nothing.
 *
 * C++ pseudo code:
 *  oldv = *pv;
 *  if (*pv == cv)
